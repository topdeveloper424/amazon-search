<template>
  <div class="home mt-3">
      ...
      <b-col cols="7">
        <b-row>
          ...
          <b-col cols="6" class="text-left">
              <b-form-datepicker id="example-datepicker" size="sm" v-model="value" class="mb-2"></b-form-datepicker>
          </b-col>
        </b-row>
        <b-row class="mt-3">
          <b-col cols="8" class="text-right" offset="1">
            <b-input-group class="mb-2" size="sm">
              ...
              <b-form-input type="search" id="searchTerm" placeholder="Search terms"></b-form-input>
            </b-input-group>
          </b-col>
    ...
    <b-row class="mt-3 mb-3">
      <b-col>
        <data-view-component :searchTerm="searchTerm" />
      </b-col>
...
export default {
  components: { DataViewComponent, SaveSearchComponent,UploadFileComponent },
  name: 'Home',
  data() {
    return {
      searchTerm:''
